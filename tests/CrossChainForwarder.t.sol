...
contract CrossChainForwarderTest is BaseTest {
  ...
  address public constant GUARDIAN = address(65566 + 12);
  // mock addresses
  address public constant DESTINATION_BRIDGE_ADAPTER = address(65566 + 12345);
  address public constant SENDER = address(65566 + 123456);

  uint256 public constant ORIGIN_LZ_CHAIN_ID = ChainIds.ETHEREUM;
  address public constant ORIGIN_SENDER = address(65566 + 1234567);
  address public constant LZ_ENDPOINT = address(65566 + 12345678);
  ...
  function testAllowBridgeAdapters() public {
    ...
    address NEW_BRIDGE_ADAPTER_1 = address(65566 + 201);
    address NEW_BRIDGE_ADAPTER_2 = address(65566 + 202);
    address NEW_DESTINATION_BRIDGE_ADAPTER_A = address(65566 + 203);
